...
<body>
    ...
    <main>
        ...
        <table>
            ...
            <tbody>
                <?php
                $select = "SELECT * FROM cor ORDER BY IDCOR;";
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $nome ?></td>
                        <td><button class="alterarBtn" data-index="<?php echo $idCor; ?>"><i class="ri-pencil-fill"></i></button></td>
                        <td><a href="../savendelete/excluirCor.php?idCor=<?php echo $idCor; ?>"><button class="excluirBtn"><i class="ri-delete-bin-5-fill"></i></button></a></td>
                    </tr>
                <?php
                }
                ?>
    ...
    <section class="forms-container">
        ...
        <form class="form" method="GET" action="../savendelete/salvarCor.php">
            ...
            <h1>Alterar Cor</h1>
            <div class="form__input-container">
                <label for="inputId">Código Da Cor: </label>
                <input type="text" id="inputId" name="inputId" class="inputHidden" value="" readonly>
            </div>
            <div class="form__input-container">
                <label for="inputName">Alterar A Cor: </label>
