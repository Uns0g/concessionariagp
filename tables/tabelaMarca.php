...
<body>
        ...
        <div id="header__buttons-container">
            ...
            <div class="dropdown-menu">
                ...
                <ul>
                    ...
                    <li><a href="tabelaModelo.php">Modelo</a></li>
                </ul>
            </div>
        </div>
    </header>
    <main>
        ...
        <table>
            ...
            <tbody>
                <?php
                $select = "SELECT * FROM marca ORDER BY IDMARCA;";
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $nome; ?></td>
                        <td><button class="alterarBtn" data-index="<?php echo $idMarca; ?>"><i class="ri-pencil-fill"></i></button></td>
                        <td><a href="../savendelete/excluirMarca.php?idMarca=<?php echo $idMarca; ?>"><button class="excluirBtn"><i class="ri-delete-bin-5-fill"></i></button></a></td>
                    </tr>
                <?php
                }
                ?>
    ...
    <section class="forms-container">
        ...
        <form class="form" method="GET" action="../savendelete/salvarMarca.php">
            ...
            <h1>Alterar Marca</h1>
            <div class="form__input-container">
                <label for="inputId">Código Da Marca: </label>
                <input type="text" id="inputId" name="inputId" class="inputHidden" value="" readonly>
            </div>
            <div class="form__input-container">
                <label for="inputName">Alterar A Marca: </label>
